...
def parse_opt(known=False):
    ...
    # TODO: set 3 Param
    parser.add_argument('--data', type=str, default=ROOT / 'data/04_dumei_coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--single-cls', nargs='?', const=True, default=True, help='train multi-class data as single-class')
